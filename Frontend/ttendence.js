...
function DonutChart({ percent, color, size = 110 }) {
  ...
  // SVG-free pure RN approach: layered border trick
  ...
  return (
    <View style={{ width: size, height: size, alignItems: 'center', justifyContent: 'center' }}>
      ...
      />
      {/* Colored ring - simple solid for RN without SVG */}
      <View
        style={{
          position: 'absolute',
          width: size,
...
// ─── Table Row ────────────────────────────────────────────────────────────────
function ClassRow({ icon, iconBg, subject, year, faculty, date, duration, attendance, attColor }) {
  return (
        ...
        <View style={[styles.section, styles.tableSection]}>
          ...
          <View style={styles.pagination}>
            ...
            <View style={styles.pageButtons}>
              ...
              <TouchableOpacity style={[styles.pageBtn, styles.pageBtnActive]}><Text style={[styles.pageBtnText, { color: C.text }]}>1</Text></TouchableOpacity>
              <TouchableOpacity style={styles.pageBtn} onPress={() => setPage(2)}><Text style={styles.pageBtnText}>2</Text></TouchableOpacity>
              <TouchableOpacity style={styles.pageBtn}><Text style={styles.pageBtnText}>›</Text></TouchableOpacity>
            </View>
          </View>
        </View>
